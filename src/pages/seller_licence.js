        ...
        return (
            <div style={{ background: 'white' }}>
                ...
                <section>
                    ...
                    Patternbank will sell your designs in two main types of license: <strong>Non-Exclusive Standard License with optional Extended options</strong> and <strong>Exclusive Premium Licenses</strong> to suit your buyers specific needs. The Standard/Extended Licensed designs can be downloaded multiple times and will be used by various licensees (so a chance for one design to generate many sales). Your design can be sold as a Premium design. Premium Exclusive License designs are sold exclusively to the buyer at a higher price point and are then removed from the site giving the buyer exclusive rights to use the design. Premium designs must be exclusive to the buyer with no other designs being similar to them (look, layout or colourway).
...
All designs uploaded must be exclusive to Patternbank.
No stock art use – use your own original work when creating artwork.
Do not upload any designs that have been purchased prior to Patternbank.
Once a design is uploaded do not resell elsewhere.
You are free to sell other designs elsewhere.
No use of copyrighted imagery.
No illegal, pornographic or prohibited items.
Premium designs must be original & exclusive.
Premium designs should not be resold or shared (Pinterest, Facebook, etc).
...
1. DEFINITIONS
"Accepted Design" means either the Accepted Standard Design or Accepted Premium Design (as applicable).

“Accepted Premium Design” means the Design uploaded by you to the Website and accepted by Patternbank for inclusion in the Premium Section.

“Accepted Standard Design” means the Design uploaded by you to the Website and accepted by Patternbank for inclusion in the Standard Section.

“Business Day” means a day (other than a Saturday, Sunday or public holiday) when banks in London are open for business.

"Design" means a print, pattern or apparel graphic and shall include all metadata, keywords, descriptions and captions associated with the Design.
...
“Licensee” means any person who is granted a licence to use an Accepted Design via the Website in accordance with the terms of the Patternbank Licensing Agreement.

“Patternbank Licensing Agreement” means the agreement under which Patternbank licenses an Accepted Design to a Licensee.

“Premium Section” the section of the Website containing Designs, each of which may only be sold on an exclusive, one-off basis to only one Licensee.

“Price” means the licence fee in relation to the Accepted Design as set by us in accordance with clause [6.1] which shall form the basis for the fee that is charged to Licensees in accordance with the Patternbank Licensing Agreement.

“Standard Section” the section of the Website containing Designs, each of which may be sold to multiple Licensees.

“Website” means patternbank.com..
