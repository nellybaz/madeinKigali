...
class About extends Component {
    ...
    handleScroll=(event)=> {
        if (Math.round(window.scrollY) >= 1220) {
                //  alert('yes')
        ...
        if(Math.round(window.scrollY) >= 1320){
        ...
        if(Math.round(window.scrollY) >= 1520){
...
{/* 
                    ...
                    {
                                     !this.state.show_store_count && <p className='counter'>8</p>
                                 }
                            ...
                            <div style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center' }}>
                                { this.state.show_store_count &&  <CountTo to={9} speed={2000}>{fn2}</CountTo> }
                        ...
                        <div className='products' style={{borderBottom:'none'}}>
                            <div className='prdt'>                          
                                
                                <div style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center' }}>
                                { this.state.turn_over_count &&  <CountTo to={800} speed={2000}>{fn}</CountTo> }
                                <p>MILLION DOLLARS IN TURN OVER</p>
                                </div>

                                <img src={require('../assets/images/6.png')} style={{height: '320px', maxWidth: '200px', position:'relative', bottom:'100px'}} />
                            </div>

                            <div className='distribution'>
                            <div style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center' }}>
                                { this.state.turn_over_count && <CountTo to={120} speed={2000}>{fn2}</CountTo> }
                                <p>Employees</p>
                                </div>
                            </div>
