...
It’s a place made to get it right to shop and be inspired to develop your own style. 
                ...
                <div>
                            ...
                            <a href="/about-us" className='c2-section2-btn'>WHO WE ARE</a>
                        </div>
                        <div>
                            ...
                            <a href="/what-we-do#what-we-do" className='c2-section2-btn'>WHAT WE DO</a>
                        </div>
                        <div>
                            ...
                            <a href="/what-we-do#mik-experience" className='c2-section2-btn'>WHAT WE GUARANTEE</a>
                        </div>
                        <div>
                            ...
                            <a href="/what-we-do#mik-brands" className='c2-section2-btn'>OUR PROJECTS</a>
                        </div>
                        <div>
                            ...
                            <a href="/what-we-do#code-of-conduct" className='c2-section2-btn'>CODE OF CONDUCT</a>
                        </div>
                </div>
    ...
    this.state.markets_count ? <CountTo to={1200} speed={2000}>{fn2_plus}</CountTo> : <h4 className='c2-counter c2-counter2'><span>+</span><br></br>1200</h4>
                ...
                <section className='c2-newsroom'>
                        <div className=''>
                            ...
                            <Link to={'#'} ><button className='access-btn'>ACCESS THE EDIT</button></Link>
                        </div>
                    </section> 
