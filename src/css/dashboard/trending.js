...
class Trending extends Component{
    ...
    async handleAddToFlashDeals(product_id){
        ...
        request
          ...
          .send({ token: "mik9876543210", tag:'trending', product_id: product_id})
        ...
        return(
            ...
            <SideBar />
              ...
              <div className='d-right-wrapper'>
                  <h5><b>ADD TRENDING</b></h5>

                  <div className='flashdeals-container'>

                  <div className='inner'>
                        <input onChange={this.handleSearch} type="search" placeholder="search product to add to trending" />
