    ...
    return (
      ...
      <div className="topmost-bar">
        ...
        <img className="audio-pause" src={this.state.music_icon} onClick={()=> this.handleTunePause()} />
          <p onClick={()=>window.location.href="#"}>Register now to get <span className="top-bar-white-text">10% off*</span> your first order with code <span onClick={()=>this.disableCookies()} className="top-bar-white-text"><b>NEWCUSTOMER10</b></span></p>
      </div>
      <header className="header">
                <div className='topbar-nav'>
                    <div className='topbar-nav-left'>
                        <Link className='student-text' to={'#'} >Student? check our student discount</Link>
                    </div>
        ...
        <div className={`mobile-nav`}>
            ...
            <Link to={'#'} className="mobile-nav-item" ><img className="mobile-logo" src={logo} /></Link>
     ...
     {/* mobile drawer ends */}
         ...
         <div className={`navigation ${this.state.nav_class}`}>
            ...
            <div className='logo-div-nav'>
                <Link to={'#'} ><img src={logo} alt="mik logo"/></Link>
            </div>
            ...
            <div className='visitrwanda'><Link to={'#'}>#VISITRWANDA</Link>
            ...
            <div className='fashion-stories'><Link to={'#'}>FASHION STORIES</Link>
